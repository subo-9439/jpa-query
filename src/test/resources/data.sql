...
--insert into user(`id`, `name`, `email`, `created_at`, `updated_at`) values (1, 'martin', 'martin@fastcampus.com', now(6), now(6));
----call next value for hibernate_sequence;
...
--insert into book(`id`, `name`, `publisher_id`, `deleted`, `created_at`, `updated_at`) values (1, 'JPA 초격차 패키지', 1, false, now(), now());
--
--insert into book(`id`, `name`, `publisher_id`, `deleted`, `created_at`, `updated_at`) values (2, 'Spring Security 초격차 패키지', 1, false, now(), now());
--
--insert into book(`id`, `name`, `publisher_id`, `deleted`, `created_at`, `updated_at`) values (3, 'SpringBoot 올인원 패키지', 1 ,true, now(), now());
